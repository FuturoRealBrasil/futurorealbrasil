        ...
        <div className="flex-1 flex flex-col justify-center max-w-sm mx-auto w-full">
          ...
          <div className="mb-4 animate-fade-up" style={{ animationDelay: "0.05s" }}>
            <Button
              ...
              variant="outline"
              className="w-full h-12 rounded-xl bg-white text-gray-800 border-white/20 hover:bg-gray-100 font-semibold flex items-center justify-center gap-3"
            >
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-xs text-primary-foreground/50">ou</span>
            <div className="flex-1 h-px bg-primary-foreground/20" />
          </div>
