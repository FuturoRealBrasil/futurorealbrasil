      ...
      <div className="flex-1 flex flex-col justify-center max-w-sm mx-auto w-full">
        {showReserva ? (
          <div key="reserva" className="animate-fade-up">
            <Label className="text-xl font-bold text-foreground block mb-6">
            ...
            <Input
              ...
              onChange={(e) => setValue("valorReserva", e.target.value)}
              className="h-14 text-lg rounded-xl bg-card"
              inputMode="numeric"
            />
              ...
              <div>
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="h-14 text-lg rounded-xl bg-card pl-12"
                    inputMode="numeric"
                  />
                </div>
                <p className="text-xs text-muted-foreground mt-2">Opcional — pode deixar em branco.</p>
              ...
              <div className="flex gap-3">
                {[
                  ...
                  <button
                    ...
                    className={`flex-1 h-14 rounded-xl border-2 text-base font-bold transition-all ${
                      formData[current.key as keyof typeof formData] === opt.value
