...
const scenarios = [
  { id: "desemprego", icon: "💼", title: "Desemprego", checklist: ["Solicite seguro-desemprego imediatamente", "Corte todos os gastos não essenciais", "Renegocie aluguel e dívidas", "Cadastre-se no SINE e sites de emprego", "Considere trabalhos temporários ou freelance", "Atualize seu CadÚnico para benefícios"], cortes: ["Streaming e assinaturas", "Delivery e alimentação fora", "Compras parceladas não essenciais"], prioridades: ["1. Alimentação", "2. Moradia", "3. Saúde", "4. Transporte para buscar emprego"] },
  { id: "doenca", icon: "🏥", title: "Doença na família", checklist: ["Verifique cobertura do SUS para seu caso", "Solicite auxílio-doença se for CLT", "Peça ajuda na UBS mais próxima", "Busque medicamentos genéricos ou pelo Farmácia Popular", "Fale com assistente social do hospital"], cortes: ["Gastos variáveis não urgentes", "Lazer temporariamente"], prioridades: ["1. Tratamento médico", "2. Alimentação adequada", "3. Moradia", "4. Medicamentos"] },
  { id: "enchente", icon: "🌊", title: "Enchente / Desastre", checklist: ["Procure abrigo seguro (Defesa Civil: 199)", "Documente danos com fotos e vídeos", "Solicite saque do FGTS por calamidade", "Cadastre-se na Defesa Civil para auxílio", "Busque doações em pontos de coleta oficiais"], cortes: ["Foque apenas no essencial até estabilizar"], prioridades: ["1. Segurança física", "2. Documentos", "3. Alimentação e água", "4. Moradia temporária"] },
  { id: "crise-precos", icon: "📈", title: "Crise de preços / Inflação", checklist: ["Substitua marcas caras por genéricas", "Compre no atacado o que puder", "Planeje refeições da semana antes de comprar", "Reduza uso de carro — priorize transporte público", "Busque promoções e compare preços online"], cortes: ["Marcas premium", "Refeições fora de casa", "Compras por impulso"], prioridades: ["1. Alimentação básica", "2. Contas fixas", "3. Transporte", "4. Saúde"] },
];
      ...
      <div className="px-5 py-6 pb-24 max-w-lg mx-auto">
        ...
        {!selected ? (
          ...
          <div className="animate-fade-up">
            <button onClick={() => setSelected(null)} className="text-sm text-primary font-semibold mb-4 flex items-center gap-1">← Voltar</button>
